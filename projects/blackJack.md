...
In the event of a loss, the player loses chips, and loses the game when they no longer have any to wager. Card data is stored within its own class, and the player’s hand is stored in a Hand class. A snippet of the Hand class is shown below:<br>
<pre>
  <code>
class Hand:
 # starter values
